...
- Adds Emotion babel config ([@jonniebigodes](https://github.com/jonniebigodes))
...
# v0.1.13 (Wed Jun 14 2023)

#### ⚠️ Pushed to `main`

- Removes unecessary files from bundle ([@jonniebigodes](https://github.com/jonniebigodes))
...
- Removes polished from peerdeps ([@jonniebigodes](https://github.com/jonniebigodes))
...
# v0.1.10 (Tue Jun 13 2023)

#### ⚠️ Pushed to `main`

- Adds babel core ([@jonniebigodes](https://github.com/jonniebigodes))
